#!/usr/bin/env python3
"""[CHECKPOINT resuelto del Lab 3] Lab 3 — la capa inteligente: QUERIES + combinación de fuentes + validadores ecuatorianos.
...
Versión resuelta: `cuadre_por_fila()` ya está implementado. Para usarla: cp checkpoints/lab3/03_inteligente.py .
"""
...
def cuadre_por_fila(campos: dict[str, Campo], tablas: list[Tabla]) -> list[str]:
    ...
    Esta es la versión RESUELTA (checkpoints/lab3): con factura_trampa produce una tercera alerta.
    """
    alertas: list[str] = []
