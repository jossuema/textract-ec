#!/usr/bin/env python3
"""Lab 2 — formularios, checkboxes y tablas con AnalyzeDocument FORMS + TABLES + LAYOUT.
...
Si te atrasas: cp checkpoints/lab2/02_formulario_tabla.py .
...
# =============================================================================
#  TU TURNO: el único TODO del taller (6-8 líneas)
# =============================================================================
def mi_pares_clave_valor(resp: dict) -> dict[str, str]:
    ...
    """
    raise NotImplementedError('escribe tu versión siguiendo la pista de arriba')
# =============================================================================
